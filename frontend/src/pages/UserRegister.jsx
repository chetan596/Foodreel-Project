...
const UserRegister = () => {
  return (
    <main className='flex justify-between items-center imageDiv'>
        <div className='h-screen md:block hidden w-[77%] user-loginImage'>
        ...
        <div className='h-full w-full flex flex-col justify-between p-10 items-center  main-login-divUser'>
            <div className=' text-center'>
                ...
                <div className='mt-3'>
                <p className='text-[1rem] text-secondary'>Jion FoodReel and explore the</p>
            ...
            <div className=' h-125 '>
                <form action="" className='flex flex-col justify-between h-full'>
                   ...
                   <div className='flex items-start mt-0.5'>
                    ...
                    <div className='mt-6'>
                        <button className='user-login-buttom'>Register</button>

                        <p className='text-center py-6 text-sm'>Already have an accound? <span className='text-[#FF4D4F]'> <Link to='/user/login'>Login</Link>  </span></p>
                    </div>
                </form>
            </div>
        </div>
